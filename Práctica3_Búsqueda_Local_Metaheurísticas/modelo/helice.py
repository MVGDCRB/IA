...
"""Modelo para el ejercicio de optimización de parámetros de una hélice.
Este script contiene las funciones necesarias para calcular el desempeño de una hélice.
No es necesario conocer los detalles de las funciones para realizar el ejercicio. 
Se utilizará la funcion calcular_helice() para evaluar el desempeño de una hélice en función de los parámetros de diseño que optimizaremos con un algoritmo genético.
...
def calcular_helice(omega, vz, R, b, 
                    h = 0, 
